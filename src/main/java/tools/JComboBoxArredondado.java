...
public class JComboBoxArredondado<E> extends JComboBox<E> {
    ...
    public JComboBoxArredondado() {
        ...
        setForeground(CorPersonalizada.DARK_GRAY.darker());
        ...
        setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                if (isSelected) {
                    ...
                    label.setForeground(CorPersonalizada.DARK_GRAY);
        ...
        protected JButton createArrowButton() {
            JButton button = new JButton() {
                ...
                public void paintComponent(Graphics g) {
                    ...
                    Graphics2D g2 = (Graphics2D) g.create();
                    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                    g2.setColor(CorPersonalizada.DARK_GRAY.brighter());
            ...
            button.addMouseListener(new MouseAdapter() {
                ...
                public void mouseExited(MouseEvent e) {
                  button.setBackground(CorPersonalizada.DARK_GRAY.brighter());
                }
            });
            return button;
        }
